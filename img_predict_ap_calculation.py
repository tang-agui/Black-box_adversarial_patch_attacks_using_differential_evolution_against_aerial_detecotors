...
imgdir = 'testset_attack_100/p_30_kron_multi_fitness/img_patched'
savedir = "ap_calculation/plane/multi_fitness_case_2"
...
for imgfile in os.listdir(imgdir):
    ...
    if imgfile.endswith('.jpg') or imgfile.endswith('.png'):  # 判断是否为指定文件结尾
        ...
        boxes_cls = utils.do_detect(model, padded_img, 0.1, 0.4, True)
        ...
        for box in boxes_attack:
            ...
            textfile.write(f'{box[6]} {box[4]} {box[0]} {box[1]} {box[2]} {box[3]}\n')    #   predictions
        textfile.close()
